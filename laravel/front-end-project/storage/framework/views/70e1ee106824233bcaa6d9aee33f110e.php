...
<div class="container">
    ...
    <div class="row" style="margin-bottom: 50px">
        <div class="col-md-6">
            <form action="<?php echo e(route('createPortfolio')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="gownName-control" name="outfitId" style="margin-bottom: 30px;">
...
<?php echo $__env->make('template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\User\Downloads\Skripsi\FE\projectskripsife\laravel\front-end-project\resources\views/portfolioCreateForm.blade.php ENDPATH**/ ?>