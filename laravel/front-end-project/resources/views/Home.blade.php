          ...
          <div class="createanaccount-frame352">
            <div class="createanaccount-createanaccount1">
              ...
              <div class="createanaccount-textfield">
                ...
                <div class="createanaccount-textfield1">
                  {{-- <div class="createanaccount-inputs">
                    <img
                      src="external/rectangle1i103-cpb9-200w.png"
                      alt="Rectangle1I103"
                      class="createanaccount-rectangle1"
                    />
                  </div> --}}
                </div>
              </div>
              <div class="createanaccount-textfield2">
                ...
                <div class="createanaccount-textfield3">
                  <div class="createanaccount-inputs1">
                    <img
                      src="external/rectangle1i104-brac-200w.png"
                      alt="Rectangle1I104"
                      class="createanaccount-rectangle11"
                    />
                  </div>
                </div>
              </div>
              <div class="createanaccount-textfield4">
                ...
                <div class="createanaccount-textfield5">
                  <div class="createanaccount-frame244">
                    <div class="createanaccount-flagdropdown">
                      <img
                        src="external/usflagi103-7666.svg"
                        alt="USflagI103"
                        class="createanaccount-u-sflag"
                      />
                      <img
                        src="external/iconsi103-1lz.svg"
                        alt="IconsI103"
                        class="createanaccount-icons"
                      />
                    </div>
                    <div class="createanaccount-inputs2">
                      <span class="createanaccount-text11">
                        <span>+1</span>
                      </span>
                      <img
                        src="external/rectangle1i103-si5-200w.png"
                        alt="Rectangle1I103"
                        class="createanaccount-rectangle12"
                      />
                    </div>
                  </div>
                </div>
              ...
              <div class="createanaccount-frame358">
                <div class="createanaccount-textfield6">
                  ...
                  <div class="createanaccount-textfield7"></div>
                </div>
              ...
              <div class="createanaccount-frame360">
                <button class="createanaccount-button">
